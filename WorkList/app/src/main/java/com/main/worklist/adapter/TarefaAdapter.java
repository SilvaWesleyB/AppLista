...
public class TarefaAdapter extends ArrayAdapter<Tarefa> {
    ...
    public TarefaAdapter(@NonNull Context context, int resource, @NonNull List<Tarefa> objects, onContactItemListner callback) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        removeButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Tarefa tarefa = getItem(position);
                TarefaAdapter.this.callback.onTrashClick(tarefa);
            }
        });
        ...
        editButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Tarefa tarefa = getItem(position);
                TarefaAdapter.this.callback.editaLista(tarefa, position);
            }
        });
